...
const getFeedbackComment = (emotionCode, score) => {
  if (score > 85) return "Outstanding expression. You truly embodied the rasa.";
  if (score > 65) return "Strong performance. Emotion is clearly visible.";
  if (score > 40) return "Decent attempt. Try exaggerating expressions more.";
  if (score > 20) return "Emotion is weak. Focus on facial clarity.";
  return "Not quite there. Try again with stronger expression.";
};
