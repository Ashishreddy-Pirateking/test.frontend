...
export const RASA_FEEDBACK = {
  HASYA: [
    "Mokam endhuku Mogga la pettav",
  ...
  SHANTA: [
    ...
    "Bhudhu di la bale shantanga unnav ayya",
  ],
  SHRINGARA: [
    "blehhh",
    "Enti idhi, ah maaku enti idhi antunna",
    "Chi",
    "kastame bro ila ayithe ammayi padatam",
